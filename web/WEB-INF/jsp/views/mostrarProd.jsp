...
<%@include file="header.jsp" %>
    ...
    $(document).ready( function () {
        ...
        <div class="container-fluid bg-info text-white p-3" style="margin-top: 80px">
            <a href="agregarProd.htm" class="btn btn-success">Agregar Producto</a>
        </div>
                <br>
                    ...
                    <table id="listadoTabla" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="actProd.htm?id=${dato.id}" class="btn btn-warning">Editar</a> 
                                    <a href="borrarProd.htm?id=${dato.id}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>
